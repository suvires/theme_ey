...
class core_renderer extends \core_renderer {
    ...
    public function context_header($headerinfo = null, $headinglevel = 2) {
        global $DB, $USER, $CFG, $SITE, $COURSE;
      ...
      */
      protected function render_context_header(context_header $contextheader) {
        ...
        if ($context->contextlevel == CONTEXT_COURSE) {
            $exporter = new \core_course\external\course_summary_exporter($COURSE, ['context' => $context]);
            $courseinfo = $exporter->export($this);            
            $heading .= $this->heading($courseinfo->coursecategory, $contextheader->headinglevel + 1);
        }
        ...
        if ($context->contextlevel == CONTEXT_COURSE) {
            $html = html_writer::start_div('context-header front-course overflow-hidden position-relative rounded shadow-sm border rounded mb-4');
        } else {
            $html = html_writer::start_div('context-header mb-4');
        }

        // Image data.
        if (isset($contextheader->imagedata)) {
            // Header specific image.
            $html .= html_writer::div($contextheader->imagedata, 'context-header-image');
        }
        ...
        // Summary.    
        if ($context->contextlevel == CONTEXT_COURSE) {    
            $html .= $this->render_from_template('core/course_header_description', $courseinfo);
        }
