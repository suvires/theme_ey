...
$THEME->iconsystem = '\\theme_ey\\output\\icon_system_fontawesome';
...
$THEME->layouts = [
    ...
    'mydashboard' => array(
        ...
        'options' => array('nonavbar' => true, 'langmenu' => false, 'nocontextheader' => true),
    ),
    ...
    'admin' => array(
        ...
        'regions' => array('side-pre'),
        'defaultregion' => 'side-pre',
        'options' => array('langmenu' => false, 'nocontextheader' => true),
    ),
    // Main course page.
    'frontpage' => array(
        'file' => 'columns2.php',
